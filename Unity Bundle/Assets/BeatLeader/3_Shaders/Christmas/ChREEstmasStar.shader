    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                const float factor  = -i.I.y * (i.I.y < 0);

                float3 diffuse_light_color = get_bulb_color(diffuse) * factor;  

                float3 reflection_col = get_bulb_color(specular) * _ReflectionTint * factor;
